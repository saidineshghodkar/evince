/* ============================================================
   ...
   ============================================================ */
const FORMS_LINK      = "https://docs.google.com/forms/d/e/1FAIpQLSdvoYGyc7ga21aPe2ft257fdzVzOic6omugz3c13Gn_6V3K3A/viewform?usp=publish-editor";
...
const DATA = {
  site: {
    ...
    marquee: "PAPER PRESENTATION,CIRCUIT DEBUGGING,PROJECT EXPO,POSTER PRESENTATION,TECH QUIZ,TREASURE HUNT,SPORTS EVENT"
  },
  stats: [
    { num: "8", label: "EVENTS" },
  ...
  benefits: [
    { icon: "🏆", title: "₹25,000+ Prize Pool", desc: "Cash prizes, trophies, medals, shields and goodies across 7 events — from Paper Presentation to Robo Combat." },
  ...
  events: [
        { name: "Paper Presentation", category: "TECHNICAL", members: "1 - 3 Members", tag: "✦ Unleash revolutionary research and engineering paradigms", desc: "Present your original research, innovative technical insights, and ECE advancements before an esteemed jury."},
    { name: "Project Expo", category: "TECHNICAL", members: "2 - 4 Members", tag: "✦ Bring your hardware prototypes and silicon blueprints to life", desc: "Demonstrate live working engineering projects, IoT builds, electronic prototypes, and automated systems."},
    { name: "Circuit Debugging", category: "TECHNICAL", members: "1 - 2 Members", tag: "✦ Troubleshoot silicon faults, oscilloscope anomalies, and breadboard bugs", desc: "Test your circuit forensics. Identify hardware faults, rectify flawed breadboards, and trace voltage signals." },
    { name: "Poster Presentation", category: "TECHNICAL", members: "1 - 3 Members", tag: "✦ Showcase your ideas through creative poster design", desc: "Showcase your innovative ideas through visually engaging posters and structured technical storytelling.", prize: "₹2,500 + Gold Badge" },
    { name: "Tech Quiz (ElectroTrivia)", category: "TECHNICAL", members: "2 Members", tag: "✦ Ignite synaptic sparks across silicon and space telemetry", desc: "Rapid-fire quiz testing knowledge in electronics, semiconductors, communication history, AI, and futuristic gadgets." },
    { name: "Campus Treasure Hunt", category: "NON-TECHNICAL", members: "3 - 4 Members", tag: "✦ Crack cryptic riddles and explore every corner of SKUCET", desc: "A thrilling adventure where teams decipher cryptic tech clues leading to hidden geo-caches across campus." },
    { name: "Surprise Events", category: "SPOT", members: "1 - 3 Members", tag: "✦ Surprise events are planned on the spot", desc: "A spontaneous tech & sensory challenge revealed on the spot. Instant registrations and instant prizes!", prize: "Instant Cash Prize + Goodies" },
    { name: "Sports Event", category: "NON-TECHNICAL", members: "Individual / Team", tag: "✦ Bring your energy, teamwork, and competitive spirit", desc: "A campus sports challenge for participants who want to compete beyond the technical arenas.", prize: "Trophies + Certificates" }
  ],
  schedule: {
    day1: {
      label: "Day 01", date: "13-10-2026",
      theme: "DAY 1: TECHNICAL EVENTS & CAMPUS EXPERIENCES",
      items: [
        { type: "TECHNICAL", time: "09:00 AM", title: "Paper Presentation", desc: "Presentations on AI, electronics, future ECE, and underwater wireless technology.", venue: "Seminar Hall A" },
        { type: "TECHNICAL", time: "10:30 AM", title: "Circuit Debugging", desc: "Find and fix circuit faults through practical electronics troubleshooting.", venue: "ECE Hardware Lab" },
        { type: "TECHNICAL", time: "12:00 PM", title: "Project Expo", desc: "Explore innovative hardware prototypes and working engineering projects.", venue: "Main Expo Hall" },
        { type: "BREAK", time: "01:00 PM", title: "Lunch Break", desc: "A lunch break for participants and organizers.", venue: "Campus Dining Commons" },
        { type: "TECHNICAL", time: "02:00 PM", title: "Poster Presentation", desc: "Share technical ideas through creative poster design and clear explanation.", venue: "Seminar Hall B" },
        { type: "TECHNICAL", time: "03:00 PM", title: "Tech Quiz", desc: "A fast-paced quiz covering electronics, technology, and engineering knowledge.", venue: "Main Auditorium" },
        { type: "NON-TECHNICAL", time: "04:00 PM", title: "Treasure Hunt", desc: "Follow clues, solve challenges, and explore the SKUCET campus with your team.", venue: "Campus Quadrangle" },
        { type: "NON-TECHNICAL", time: "05:00 PM", title: "Sports Event", desc: "An energetic campus sports challenge focused on teamwork and friendly competition.", venue: "SKUCET Sports Ground" }
      ]
    },
    day2: {
      label: "Day 02", date: "14-10-2026",
      theme: "DAY 2: College Students Evensts",
      items: [
        {  type: "GENERAL", title: "Registration & Welcome Kit Distribution", desc: "Participant kit collection, badge allocation, and campus orientation.", venue: "Registration Desk / Auditorium Foyer" },
        {  type: "CEREMONY", title: "Grand Inauguration Ceremony & Lamp Lighting", desc: "Opening keynote by Dignitaries, HOD address, and unveiling of EVINCE 2K26 theme video.", venue: "Main Auditorium, SKUCET" },
        {  type: "TECHNICAL", title: "Paper Presentation (Round 1)", desc: "Research presentations in VLSI, Signal Processing, AI & IoT.", venue: "Seminar Hall A" },
        {  type: "TECHNICAL", title: "Project Expo (Hardware Prototype Arena)", desc: "Live prototype showcase evaluated by distinguished jury.", venue: "ECE Hardware Lab / Main Expo Hall" },
        {  type: "BREAK", title: "Networking & Lunch Break", desc: "Lunch and informal participant interactions.", venue: "Campus Dining Commons" },
        {  type: "TECHNICAL", title: "Coding Challenge (Algorithmic Sprint)", desc: "Fast-paced logic and data structures tournament.", venue: "System Center / Lab 2" },
        {  type: "TECHNICAL", title: "Tech Quiz (ElectroTrivia Preliminary)", desc: "Fastest-finger buzzer elimination round.", venue: "Seminar Hall B" },
        {  type: "NON-TECHNICAL", title: "Campus Treasure Hunt", desc: "Cryptic outdoor quest linking clues across university landmarks.", venue: "Campus Quadrangle" },
        {  type: "CULTURAL", title: "Day 1 Cultural Vibes & Music Showcase", desc: "Acoustic performances and student musical bands.", venue: "Open Air Theatre" }
      ]
  ...
  faqs: [
    ...
    { q: "Is accommodation available?", a: "No, Not Available.Student should make their own arrangements." },
  ...
  contact: {
    ...
    instagram: "https://www.instagram.com/evince2k26?stkn=MTVybDY1NGZ1dWRsag==",
    youtube: "https://youtube.com/@evince2k26?si=oWTZZBa05_evMykG"
  }
};
...
function bindFormLinks() {
  ["regBtn1", "formBtn1"].forEach(id => { const el = document.getElementById(id); if (el) el.href = FORMS_LINK; });
...
/* ---------------- NAVBAR ---------------- */
const NAV = ["HOME", "WHY JOIN", "ABOUT", "EVENTS", "SCHEDULE", "ORGANIZERS", "FAQ", "LOCATION", "CONTACT"];
const NAV_IDS = { "home": "home", "why join": "whyjoin", "about": "about", "events": "events", "schedule": "schedule", "organizers": "team", "faq": "faq", "location": "location", "contact": "contact" };
function renderNav() {
...
function initTheme() {
  ...
  const saved = localStorage.getItem("evince-theme") || "dark";
  document.documentElement.dataset.theme = saved;
  toggle.innerHTML = saved === "dark" ? "<span>☼</span>" : "<span>☾</span>";
  toggle.setAttribute("aria-label", saved === "dark" ? "Switch to light theme" : "Switch to dark theme");
  toggle.onclick = () => {
    const next = document.documentElement.dataset.theme === "dark" ? "light" : "dark";
    document.documentElement.dataset.theme = next;
    localStorage.setItem("evince-theme", next);
    toggle.innerHTML = next === "dark" ? "<span>☼</span>" : "<span>☾</span>";
...
window.addEventListener("DOMContentLoaded", () => {
  renderNav(); initTheme(); bindFormLinks(); renderHero(); initCountdown(); renderBenefits(); renderAbout();
  initCarousel(); renderEvents(); renderSchedule(); renderTeam();
  // renderSponsors();
  renderFaqs(); renderLocation(); renderContact();
